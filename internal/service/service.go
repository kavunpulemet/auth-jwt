...
type AuthorizationService interface {
	SignIn(ctx utils.MyContext, userID, userIP string) (models.TokenPair, error)
...
func (s *ImplAuthorizationService) SignIn(ctx utils.MyContext, userID, userIP string) (models.TokenPair, error) {
